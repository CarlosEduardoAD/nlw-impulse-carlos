...
export function WidgetForm(){
    ...
    return(
        ...
        {feedbackSent ? (
            ...
            <footer>
                <div>Feito de maneira com ajuda da <a className="underline underline-offset-1" href="https://www.rocketseat.com.br/">Rocketseat</a> por <a className="underline underline-offset-1" href="https://github.com/Karl-developer">Carlos Eduardo</a></div>
            </footer>
        </div>
    )
